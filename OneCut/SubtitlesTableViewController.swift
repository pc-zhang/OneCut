//
//  SubtitlesTableViewController.swift
//  OneCut
//
...
class SubtitlesTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "subtitleSegment", for: indexPath)
        let row = indexPath.row

        // Configure the cell...
        guard let subtitleSegmentCell = cell as? SubtitleTableViewCell else {
            return cell
        }
