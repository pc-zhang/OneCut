        ...
        */
		...
		for passthroughReaderOutput in passthroughReaderOutputs {
            ...
            */
            ...
            let passthroughWriterInput = AVAssetWriterInput(mediaType: AVMediaType(rawValue: passthroughReaderOutput.mediaType), outputSettings: nil, sourceFormatHint: passthroughFormatHint)
